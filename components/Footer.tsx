...
const socialLinks = [
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/donato-carpentiere-329039283/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-3 bg-card-bg border border-card-border rounded-lg text-text-muted hover:border-accent hover:text-accent transition-all duration-300"
        ...
        <div className="pt-8 border-t border-card-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-text-muted text-sm text-center sm:text-left">
            &copy; {currentYear} Donato Carpentiere. {t("rights")}
          </p>
